            ...
            <div>
                ...
                <div className="container">
                    <div>
                        ...
                        <input type="button" className="button" value=" Click to see the Image Gallery" onClick={() => this.handleModal('galleryModal', true)}/>
                    </div>
                    ...
                    <div className="tabs">
                        ...
                        <div className="tab">
                            ...
                            <div className="content">
                                ...
                                <div className="value mt-1">{restaurant.contact_number}</div>
                                <div className="head mt-3">{restaurant.name}</div>
                                <div className="value mt-1">{`${restaurant.address}`}</div>
                            </div>
                        </div>
                    </div>   
                </div>
                ...
                >
                    ...
                    <Carousel showThumbs={false} showStatus={false}>
                        <div>
                            <img src={restaurant.thumb} className="bannerImg" alt="I" />
                        </div>
                    </Carousel>
                                    ...
                                    <div className="" style={{ width: '44rem', margin: '' }}>
                                        <div className="row" style={{ paddingLeft: '10px', paddingBottom: '10px' }}>
                                            ...
                                            <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <img className="card-img-center title-img" src={`./img/${item.image}`} alt="I" style={{
                                                    height: '90px',
                                                    width: '90px',
                                                    borderRadius: '5px',
                                                    marginTop: '2px',
                                                ...
                                                {item.qty == 0 ? <div>
                                                    <button className="btn btn-danger" onClick={() => this.addItems(index, 'add')}>+</button>
                                                </div> :
